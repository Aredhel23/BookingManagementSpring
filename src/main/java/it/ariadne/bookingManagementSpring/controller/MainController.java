...
import it.ariadne.bookingManagementSpring.utils.AvailabilityUtils;
...
public class MainController {
	...
	@RequestMapping(value = { "/admin/richieste" }, method = RequestMethod.GET)
	...
	@RequestMapping(value = { "/user/risorseutente" }, method = RequestMethod.GET)
